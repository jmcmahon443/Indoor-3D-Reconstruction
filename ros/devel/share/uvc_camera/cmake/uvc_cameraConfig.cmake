...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/joe/Documents/Indoor-3D-Reconstruction/ros/src/camera_umd/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/joe/Documents/Indoor-3D-Reconstruction/ros/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/joe/Documents/Indoor-3D-Reconstruction/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joe/Documents/Indoor-3D-Reconstruction/ros/src/camera_umd/uvc_camera/${idir}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${uvc_camera_dep}_FOUND)
      find_package(${uvc_camera_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${uvc_camera_dep} REQUIRED ${depend_list})
  endif()
